      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
        ...
        <div className="p-6 sm:p-10 lg:p-12">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-6 border-b border-gray-800 pb-6">
            ...
            <span
              className={`mt-3 sm:mt-0 px-4 py-1 rounded-full text-sm font-semibold uppercase tracking-wider ${
                loan.color === "green"
          ...
          <div className="mt-8">
            <NavLink
              ...
              onClick={(e) => {
                ...
                onApplyClick(loan.loanTitle);
              }}
              className={`w-full inline-flex items-center justify-center px-8 py-4 border border-transparent text-xl font-bold rounded-lg shadow-xl transition duration-300 focus:outline-none focus:ring-4
      ${
        isDisabled
