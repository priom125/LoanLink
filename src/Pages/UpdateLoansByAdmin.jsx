          ...
          <form onSubmit={handleSubmit(handleUpdate)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
              ...
              <div className="flex items-end lg:pb-3">
                <label className="flex items-center gap-3 cursor-pointer bg-gray-700 hover:bg-gray-600 px-4 py-3 rounded-lg transition-colors">
                  <input
                    id="showOnHome"
                    type="checkbox"
                    {...register('showOnHome')}
                    className="h-5 w-5 rounded border-gray-500 text-blue-600 focus:ring-2 focus:ring-blue-500 cursor-pointer"
                  />
...
export default UpdateLoansByAdmin