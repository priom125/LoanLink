...
function AllLoan() {
    ...
    const {data:AllLoanCategory = []} = useQuery({
          ...
          {AllLoanCategory.map((loan) => (
            <tr key={loan._id}>
              ...
              <td className="space-x-2">
               <NavLink to={`/dashboard/all-loan/update-loan/${loan._id}`} className="btn btn-success btn-sm">Update</NavLink>
