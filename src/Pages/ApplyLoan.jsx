            ...
            <div className="w-full max-w-3xl bg-gray-800 p-6 md:p-10 rounded-xl shadow-2xl border border-gray-700 transform transition-all duration-300 hover:shadow-3xl">
                ...
                {submissionStatus === 'error' && (
                    <div className="mb-6 p-4 bg-red-900/40 border-l-4 border-red-500 text-red-300 rounded-lg" role="alert">
                        ...
                        <p>There was an issue processing your application. Please check your inputs.</p>
                    </div>
                )}
                ...
                <div className="mb-8 p-4 bg-gray-700 rounded-lg grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm font-medium">
                    ...
                    <div className="col-span-1 lg:col-span-1">
                        <p className="text-gray-400 flex items-center"><Percent className="w-4 h-4 mr-2" /> Interest Rate</p>
                        <p className="text-white">{AUTO_FILL_DATA.interestRate}</p>
                    </div>
                    <div className="col-span-1 lg:col-span-1">
                        <p className="text-gray-400 flex items-center"><TrendingUp className="w-4 h-4 mr-2" /> Status</p>
                ...
                <form onSubmit={handleSubmit(handelApplySubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2 bg-gray-700 text-white border ${errors.contactNumber ? 'border-red-500' : 'border-gray-600 focus:ring-indigo-500'} rounded-lg shadow-sm placeholder-gray-500 focus:outline-none focus:border-indigo-500 transition duration-150 ease-in-out sm:text-sm`}
                                    placeholder="+1 555 123 4567"
                                />
                            </div>
                            {errors.contactNumber && <ErrorMessage message={errors.contactNumber.message} />}
                        </div>

                        {/* National ID / Passport Number */}
                        <div>
                            <label htmlFor="nationalID" className="block text-sm font-medium text-gray-300 mb-1">National ID / Passport Number</label>
                            <div className="relative">
                            ...
                            {errors.nationalID && <ErrorMessage message={errors.nationalID.message} />}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         {/* Income Source */}
                         <div>
                            <label htmlFor="incomeSource" className="block text-sm font-medium text-gray-300 mb-1">Income Source (e.g., Employment, Self-Employed)</label>
                            <div className="relative">
                            ...
                            {errors.incomeSource && <ErrorMessage message={errors.incomeSource.message} />}
                        </div>
                        
                        {/* Monthly Income */}
                        <div>
                            <label htmlFor="monthlyIncome" className="block text-sm font-medium text-gray-300 mb-1">Monthly Income (Gross)</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2 bg-gray-700 text-white border ${errors.monthlyIncome ? 'border-red-500' : 'border-gray-600 focus:ring-indigo-500'} rounded-lg shadow-sm placeholder-gray-500 focus:outline-none focus:border-indigo-500 transition duration-150 ease-in-out sm:text-sm`}
                                    placeholder="5000.00"
                                />
                            </div>
                    ...
                    {/* Loan Amount */}
                    <div>
                        <label htmlFor="loanAmount" className="block text-sm font-medium text-gray-300 mb-1">Loan Amount Requested</label>
                        <div className="relative">
                            <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
                            <input
                                id="loanAmount"
                                ...
                                className={`w-full pl-10 pr-4 py-2 bg-gray-700 text-white border ${errors.loanAmount ? 'border-red-500' : 'border-gray-600 focus:ring-indigo-500'} rounded-lg shadow-sm placeholder-gray-500 focus:outline-none focus:border-indigo-500 transition duration-150 ease-in-out sm:text-sm`}
                                placeholder="10000"
                            />
                        </div>
                    ...
                    <div>
                        <label htmlFor="address" className="block text-sm font-medium text-gray-300 mb-1">Current Address</label>
                        <div className="relative">
                    ...
                    <div>
                        <label htmlFor="reasonForLoan" className="block text-sm font-medium text-gray-300 mb-1">Reason for Loan</label>
                        <div className="relative">
                        ...
                        {errors.reasonForLoan && <ErrorMessage message={errors.reasonForLoan.message} />}
                    </div>

                    {/* Extra Notes (Textarea) */}
                    <div>
                        <label htmlFor="extraNotes" className="block text-sm font-medium text-gray-300 mb-1">Extra Notes (Optional)</label>
                        <div className="relative">
                            <Edit3 className="absolute left-3 top-3 w-5 h-5 text-gray-500" />
                            <textarea
                                id="extraNotes"
