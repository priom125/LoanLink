...
function Navbar() {
  ...
  const renderAvatar = () => {
    ...
    const initial = (user?.displayName || user?.email || "U")
      ...
      .toUpperCase();
    return (
      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 text-white flex items-center justify-center font-semibold">
        {initial}
      </div>
    );
  };
  ...
  return (
    <div className="navbar bg-base-100 shadow-md px-4 lg:px-8">
      ...
      {/* NAVBAR CENTER - Hidden on mobile, shown on desktop */}
      ...
      {/* NAVBAR END - Auth buttons and theme toggle */}
      <div className="navbar-end gap-3">
        ...
        {loading || userDataLoading ? (
          ...
          <div className="flex gap-2">
            ...
            <NavLink to="/register" className="btn btn-sm btn-outline hidden sm:flex">
              Register
            </NavLink>
          </div>
        )}
